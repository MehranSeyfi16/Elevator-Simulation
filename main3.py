...
class Elevator:
    ...
    def scan(self):
        ...
        self.down = list(set(self.down))
        self.up = list(set(self.up))
...
class GUI:
    ...
    def __init__(self):
        ...
        self.E2Button8 = None
        self.E2Button9 = None
        self.E2Button10 = None
        self.E2Button11 = None
        self.E2Button12 = None
        self.E2Button13 = None
        self.E2Button14 = None
        self.E2Button15 = None
        self.E3Button1 = None
        self.E3Button2 = None
        self.E3Button3 = None
        self.E3Button4 = None
        ...
        self.E3Button8 = None
        self.E3Button9 = None
        self.E3Button10 = None
        self.E3Button11 = None
        self.E3Button12 = None
        self.E3Button13 = None
        self.E3Button14 = None
        self.E3Button15 = None
    ...
    def root_window(self):
        ...
        # threading.Thread(target=self.check_move).start()
        # self.check_move()
    ...
    def func(self, message, elevator):
        print("message and elevator")
        print(message)
        print(elevator)
        ...
        if int(elevator) == 0:
            ...
            # GUI.first_elevator.direction = DIR
            print(f"internal request in Elevator {int(elevator)}")
            # GUI.first_elevator.array.append(int(message))
            if GUI.first_elevator.direction == "up":
                GUI.first_elevator.up.append(int(message))
                # print(GUI.first_elevator.up)
                # GUI.first_elevator.array.append(int(message))
                GUI.first_elevator.up.sort()
                # print("up")
                # print(GUI.first_elevator.up)
                ...
                GUI.first_elevator.down.sort()
                # print("down")
                # print(GUI.first_elevator.down)

        elif int(elevator) == 2:
            print(f"internal request in Elevator {int(elevator)}")
            # GUI.second_elevator.direction.append(int(message))
            ...
            print(f"internal request in Elevator {int(elevator)}")
            # GUI.third_elevator.direction.append(int(message))
    ...
    def movement(self):
        # DIR = GUI.first_elevator.find_direction()
        # GUI.first_elevator.direction = DIR
        # print(DIR)
        # print(GUI.first_elevator.array)
        # print("array")
        ...
        # print(abs(725 - 50 * (GUI.first_elevator.up[0] - 1)))

        if GUI.first_elevator.direction == "up":
            try:
                # print("GUI.first_elevator.up[0]")
                # print(GUI.first_elevator.up[0])
                # print("self.current_y")
                # print(self.current_y)
                ...
                for i in range(len(GUI.first_elevator.up)):
                    GUI.first_elevator.up.sort()
                    up_check_first_elevator = GUI.first_elevator.up[i]

                    # print("________")
                    # print(up_check_first_elevator)
                    # print("up")
                    # print(GUI.first_elevator.up)
                    # print(self.current_y)
                    # print("head")
                    # print(GUI.first_elevator.head)
                    # print("_______")
                    if self.current_y == abs(725 - 50 * (up_check_first_elevator - 1)):
                        print(
                            f"reached floor up1________________________________________________:{up_check_first_elevator}")
        ...
        if GUI.first_elevator.direction == "down":
            ...
            try:
                # print("head1")
                # print(GUI.first_elevator.head)
                for i in GUI.first_elevator.down[::-1]:
                    # print("arrrrrrrrrrrrrrrrrrrr")
                    # print(i)

                    down_check_first_elevator = i
                    if self.current_y == abs(725 - 50 * (down_check_first_elevator - 1)):
                        print(
                            f"reached floor down1________________________________________________:{down_check_first_elevator}")
            ...
            try:
                for i in range(len(GUI.second_elevator.up)):
                    ...
                    if self.current_y2 == abs(725 - 50 * (up_check_second_elevator - 1)):
                        print(
                            f"reached floor up2________________________________________________:{up_check_second_elevator}")
        ...
        if GUI.second_elevator.direction == "down":
            try:
                for i in GUI.second_elevator.down[::-1]:
                    down_check_second_elevator = i
                    if self.current_y2 == abs(725 - 50 * (down_check_second_elevator - 1)):
                        print(
                            f"reached floor down2________________________________________________:{down_check_second_elevator}")
            ...
            try:
                for i in range(len(GUI.third_elevator.up)):
                    ...
                    if self.current_y3 == abs(725 - 50 * (up_check_third_elevator - 1)):
                        print(
                            f"reached floor up3________________________________________________:{up_check_third_elevator}")
        ...
        if GUI.third_elevator.direction == "down":
            try:
                for i in GUI.second_elevator.down[::-1]:
                    down_check_third_elevator = i
                    if self.current_y3 == abs(725 - 50 * (down_check_third_elevator - 1)):
                        print(
                            f"reached floor down3________________________________________________:{down_check_third_elevator}")
